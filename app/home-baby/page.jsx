...
export default function HomeBabyPage() {
  const products = [
    { id: 1, name: "Home & Baby Item 1", price: "£34.99", image: "/placeholder-product.jpg" },
    { id: 2, name: "Home & Baby Item 2", price: "£44.99", image: "/placeholder-product.jpg" },
    { id: 3, name: "Home & Baby Item 3", price: "£29.99", image: "/placeholder-product.jpg" },
    { id: 4, name: "Home & Baby Item 4", price: "£39.99", image: "/placeholder-product.jpg" },
    { id: 5, name: "Home & Baby Item 5", price: "£49.99", image: "/placeholder-product.jpg" },
    { id: 6, name: "Home & Baby Item 6", price: "£32.99", image: "/placeholder-product.jpg" },
    { id: 7, name: "Home & Baby Item 7", price: "£37.99", image: "/placeholder-product.jpg" },
    { id: 8, name: "Home & Baby Item 8", price: "£42.99", image: "/placeholder-product.jpg" },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center text-white space-y-4">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              From Trusted Global Markets to Your Doorstep. Create a comfortable home and nurture your little ones with our carefully curated collection.
            </p>
          </div>
        </div>
      </section>
            ...
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow group">
                ...
                <div className="p-5">
                  ...
                  <p className="text-gray-600 mb-4 text-sm">Premium quality home & baby product</p>
