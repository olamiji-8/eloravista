...
export default function DrinkwarePage() {
  const products = [
    { id: 1, name: "Drinkware Item 1", price: "£14.99", image: "/placeholder-product.jpg" },
    { id: 2, name: "Drinkware Item 2", price: "£19.99", image: "/placeholder-product.jpg" },
    { id: 3, name: "Drinkware Item 3", price: "£12.99", image: "/placeholder-product.jpg" },
    { id: 4, name: "Drinkware Item 4", price: "£24.99", image: "/placeholder-product.jpg" },
    { id: 5, name: "Drinkware Item 5", price: "£16.99", image: "/placeholder-product.jpg" },
    { id: 6, name: "Drinkware Item 6", price: "£18.99", image: "/placeholder-product.jpg" },
    { id: 7, name: "Drinkware Item 7", price: "£22.99", image: "/placeholder-product.jpg" },
    { id: 8, name: "Drinkware Item 8", price: "£15.99", image: "/placeholder-product.jpg" },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center text-white space-y-4">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Stay hydrated in style with our premium drinkware collection. From elegant glassware to durable travel mugs.
            </p>
          </div>
        </div>
      </section>
            ...
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow group">
                ...
                <div className="p-5">
                  ...
                  <p className="text-gray-600 mb-4 text-sm">Premium quality drinkware</p>
